...
```bash
tamo serve   # 常駐(推奨): claude mcp add --transport http tamo http://127.0.0.1:8788/mcp
# stdio派:   claude mcp add tamo -- tamo mcp   (Cursor/Codex CLI等も同じ)
```
...
tamo/
  ...
  cli.py         probe/collect/serve/search/recall/show/pack/mirror/rules/prune… 19コマンド
