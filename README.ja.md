...
- **保持期間を決める前に [無期限保存のリスクと運用指針](docs/ARCHITECTURE.md) を一読を** —
...
| [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) | 設計原則・データモデル・最適化・還流・保存期間リスク・NFR |
| [docs/TECH_STACK.md](docs/TECH_STACK.md) | 技術選定の理由と実装ファイルの対応表 |
| [docs/VERIFICATION.md](docs/VERIFICATION.md) | 実機での動作確認手順 |
| [browser-extension/README.md](browser-extension/README.md) | ブラウザ拡張の詳細 |
